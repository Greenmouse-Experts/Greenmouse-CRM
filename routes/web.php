...
Route::middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('/admin/customer-management', [App\Http\Controllers\AdminController::class, 'customers'])->name('customers');
    Route::get('/admin/customer-management/add', [App\Http\Controllers\AdminController::class, 'customer_management'])->name('customer.management');
    Route::post('/admin/customer-management/save', [App\Http\Controllers\AdminController::class, 'add_customer_management'])->name('add.customer.management');
    Route::get('/admin/customer-management/view/{id}', [App\Http\Controllers\AdminController::class, 'view_customer_management'])->name('view.customer.management');
    Route::post('/admin/customer-management/update/{id}', [App\Http\Controllers\AdminController::class, 'update_customer_management'])->name('update.customer.management');
    Route::post('/admin/customer-management/delete/{id}', [App\Http\Controllers\AdminController::class, 'delete_customer_management'])->name('delete.customer.management');
