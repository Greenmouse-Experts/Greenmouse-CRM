...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <!-- Content Row -->
            <form method="POST" action="{{ route('add.customer.management') }}" enctype="multipart/form-data">
                 @csrf
                 <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <span class="m-0 font-weight-bold text-primary">Add Customer</span>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="property_of_interest" placeholder="Property of Interest" aria-describedby="helpId" required>                                               
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="offer" placeholder="Amount to Offer" aria-describedby="helpId" required>                                               
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="when_do_you_want_to_move_in" placeholder="When Do You Want To Move In?" aria-describedby="helpId" required>                                               
                                            </div>
                                        </div>
                                    </div>
