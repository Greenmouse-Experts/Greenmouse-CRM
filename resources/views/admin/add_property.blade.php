                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <span class="m-0 font-weight-bold text-primary">Add Property</span>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" rows="3"
                                                    placeholder="e.g Excision in Progress"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="per_sqm"
                                                    id="" aria-describedby="helpId" value=""
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="payment_plans" rows="3"
                                                    placeholder="e.g 1-2months: ₦800k, 3 months: ₦900,000, 6 months: ₦1,000,000, Initial Deposit: ₦400,000"></textarea>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="features" rows="3"
                                                    placeholder="e.g Perimeter Fencing, Good Road Networks, Security, Water"></textarea>
                                                    <small class="text-danger">Separate items with the comma(,) sign</small>
                                            </div>
                                        </div>
                                    </div>
